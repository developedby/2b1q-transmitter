...
class Ui_ReceiveWindow(object):
    def setupUi(self, ReceiveWindow):
        ...
        self.graph_groupbox.setGeometry(QtCore.QRect(9, 182, 711, 281))
        self.graph_groupbox.setTitle("")
        self.graph_groupbox.setObjectName("graph_groupbox")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.graph_groupbox)
        ...
        self.verticalLayout.addWidget(self.binary_wave)
        ...
        self.verticalLayout.addWidget(self.encoded_wave)
